...
function buildCardHTML(d) {
  ...
  var css=""
    ...
    +".story{font-size:10px;color:#0a0a0a;line-height:1.5;margin-bottom:8px}"
    +".story strong{font-weight:800}"
    +".story .grn{color:#22c55e;font-weight:800}"
    +".value{font-size:24px;font-weight:800;color:#0a0a0a;letter-spacing:-1px;line-height:1;margin-bottom:5px}"
